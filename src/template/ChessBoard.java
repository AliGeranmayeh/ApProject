...
public class ChessBoard extends Pane {
	...
	public void initPiece()
	{
		...
		pieces[7][7] = rook_1_2;
		//fgfgfdSsfsd //why 1,2,0 in board
	...
	public void resetGame() {
		...
		statusBar.blackPlayerAlert.setText("");
		//changes
		statusBar.whitePlayerTimer.setText("White timer: 30:00");
		statusBar.blackPlayerTimer.setText("Black timer: 30:00");
		...
		//changes
		timer.whiteTimer = 1800;
		timer.blackTimer = 1800;
		timer.playerTurn = current_player;
		timer.timeline.play();
	}
	...
	public void colorSquare(int x, int y, boolean selectedPiece) {
		if (selectedPiece)
			windows[x][y].highlightWindow(Color.CYAN);
		else
